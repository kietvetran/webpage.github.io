...
(function ($, window, document) {
    ...
    var Carousel = {
        ...
        gestures : function () {
            ...
            base.$elem.on(base.evTypes.start, ".owl-wrapper", dragStart);
        },
        ...
        closestItem : function () {
            ...
            $.each(array, function (i, v) {
                ...
                } else if (goal + (base.itemWidth / 20) < v && goal + (base.itemWidth / 20) > (array[i + 1] ||
                    array[i] - base.itemWidth) && base.moveDirection() === "right") {
                    if (base.options.scrollPerPage === true) {
