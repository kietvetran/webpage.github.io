...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx,js"
s.linkInternalFilters="javascript:sparebank1.no" //optional: add your internal domain here
...
function s_doPlugins(s) {
	...
	//External campaigns: capture the cid query parameter in s.campaign
	//s.campaign = s.Util.getQueryParam("cid");
	
	//Internal promotions: capture the icid query parameter in eVar53
	//s.eVar53 = s.Util.getQueryParam("icid");
	
	//Previous page: set previous page name in eVar3
	//s.eVar3 = s.Util.cookieRead("previouspagename");
	
	//Previous page: write a cookie that contains s.pageName
	//s.Util.cookieWrite("previouspagename", s.pageName);
    
    /* getTimeParting set variables with different values 
    s.contextData['time_parting'] = s.getTimeParting('s','+1');
    var now     = new Date(); 
    ...
    s.contextData['time_date'] = day+'-'+month+'-'+year; */
...
s.trackingServer="sparebank1.d3.sc.omtrdc.net"
