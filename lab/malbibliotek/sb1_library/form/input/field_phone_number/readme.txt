...
teaser :=
<i class="sb1_lib_field_phone_number"></i>
...
code :=
<input value="" name="ctelephone" data-rule="telephone" spellcheck="false" autocomplete="off" type="tel">
<input value="" name="cmobile" data-rule="mobile" spellcheck="false" autocomplete="off" type="tel">
