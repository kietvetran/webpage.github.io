id := 
sb1_form_field_credit_card

range :=
7

name := 
Kredittkortnummerfelt
...
teaser :=
<i class="sb1_lib_field_credit_card"></i>
...
code :=
<input type="tel" value="" name="creditcardnumber" data-rule="creditcardnumber" spellcheck="false" autocomplete="off" minlength="16">
-d_e
