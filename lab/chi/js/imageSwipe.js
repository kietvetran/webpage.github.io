...
$.fn.imageSwipe = function ( config ) {
  ...
  ****************************************************************************/
  var opts = {
    ...
    'onSlide'    : false,
    'out'        : 0,
    'ie'         : 0,//$.browser.msie ? $.browser.version : 0,
    'waiting'    : [],
    ...
    'aNavigator' : config['arrowNavigator']  === false ? false : true,
    'bNavigator' : config['bulletNavigator'] === false ? false : true,
  ...
  var helper = {
    ...
    **************************************************************************/
    init : function() {
      if ( ! opts['main'].hasClass('screen') ) {
        opts['main'] = $('<div class="screen"></div>').appendTo( opts['main'] );
      }

      if ( ! opts['slider'].length ) {
        opts['slider'] = $('<div class="slider"></div>').appendTo( opts['main'] );
      }
